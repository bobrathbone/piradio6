...
#
# $Id: st7789tft_class.py,v 1.21 2020/05/28 19:59:29 bob Exp $
# Author : Bob Rathbone
...
if __name__ == '__main__':
	...
	def signalHandler(signal,frame):
		execCommand("sudo systemctl stop mpd")
		display.clear()
		sys.exit(0)
	...
	# Load radio 
	execCommand("sudo systemctl start mpd")
	execCommand("mpc load _Radio")
	execCommand("mpc volume " + str(volume))
	...
	while True:
		...
		#display.setFontSize(25)
		station = execCommand("mpc current")
